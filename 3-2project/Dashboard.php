                        ...
                        ?>
                    		...
                    		?>
	    						<div class="col-sm-6 box" style="margin: 0 3% 0 0;width: 47%;border: 8px solid #5f027c;cursor: pointer;">
	    							<div class="row">
	    								<div id="topic" onclick="location.href='editorials.php?ids=<?php echo $sub_row['link'] ?>'" class="col-sm-3">
	    									<p>hello</p>
	    								...
	    								<div id="topic" onclick="location.href='editorials.php?ids=<?php echo $sub_row['link'] ?>'" class="col-sm-6" style="padding-top: 9%;color: #fff">
	    									..................................................
	    								</div>
	    							...
	    							<div id="topic" onclick="location.href='editorials.php?ids=<?php echo $sub_row['link'] ?>'" class="row">
	    								<div class="col-sm-12">
